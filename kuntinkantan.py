...
# Place code here
# Draw a circle or a given radius given its position
def draw_circle(radius, x_position, y_position):
    turtle.penup()
...
# Draw the circle in the top left quadrant
draw_circle(80, -90, 10)

# Draw the circle in the top right quadrant
draw_circle(80, 90, 10)

# Draw the circle in the bottom right quadrant
draw_circle(80, 90, -170)

# Draw the circle in the bottom left quadrant
draw_circle(80, -90, -170)
